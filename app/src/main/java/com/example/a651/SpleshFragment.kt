...
import com.example.a651.databinding.FragmentSpleshBinding
...
class SpleshFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.spleshText.startAnimation(AnimationUtils.loadAnimation(binding.root.context,R.anim.anim360))
